...
@Component({
  selector: 'app-silica',
  templateUrl: './silica.component.html',
  styleUrls: ['./silica.component.scss']
})
export class SilicaComponent implements AfterViewInit, OnDestroy {
  ...
  createBarChart(data: any[]): void {
    ...
    const svg = d3.select('#chartContainerSilica')
      .append('svg')
      .attr('width', svgWidth)
