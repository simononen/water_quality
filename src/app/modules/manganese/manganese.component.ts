...
@Component({
  selector: 'app-manganese',
  templateUrl: './manganese.component.html',
  styleUrls: ['./manganese.component.scss']
})
export class ManganeseComponent implements AfterViewInit, OnDestroy {
  ...
  createBarChart(data: any[]): void {
    ...
    const svg = d3.select('#chartContainerManganese')
      .append('svg')
      .attr('width', svgWidth)
