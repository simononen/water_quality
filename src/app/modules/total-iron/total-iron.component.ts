...
@Component({
  selector: 'app-total-iron',
  templateUrl: './total-iron.component.html',
  styleUrls: ['./total-iron.component.scss']
})
export class TotalIronComponent implements AfterViewInit, OnDestroy {
