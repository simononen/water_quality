...
@Component({
  selector: 'app-total-chlorine',
  templateUrl: './total-chlorine.component.html',
  styleUrls: ['./total-chlorine.component.scss']
})
export class TotalChlorineComponent implements AfterViewInit, OnDestroy {
  ...
  private initMap(): void {
    this.map = L.map('map_total_chlorine', {
  ...
  createBarChart(data: any[]): void {
    ...
    const svg = d3.select('#chartContainerTotalChlorine')
      .append('svg')
      .attr('width', svgWidth)
